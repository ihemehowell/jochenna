  ...
  return (
    <main className="min-h-screen bg-gray-50 px-4 py-10 md:px-8">
      <div className="mx-auto max-w-3xl rounded-lg border border-gray-200 bg-white p-8 text-center">
        <h2 className="mb-3 text-2xl font-semibold text-gray-900">Checkout unavailable</h2>
        <p className="mb-8 text-gray-600">{error.message || "Please try again to complete your order."}</p>
