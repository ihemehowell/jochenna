...
export default function OrdersPage() {
  ...
  return (
    <main className="px-4 py-10 md:px-8 bg-paper min-h-screen">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
          <p className="text-xs uppercase tracking-[0.28em] text-ink-soft">Account</p>
          <h1 className="mt-2 text-4xl font-semibold text-ink">My Orders</h1>
          <p className="mt-3 text-ink-soft">Track recent purchases and open individual order details.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-3xl border border-dashed border-hairline bg-white p-8 text-center">
            <p className="text-ink-soft">You do not have any orders yet.</p>
            <Link
              href="/shop"
              className="mt-4 inline-flex rounded-full bg-ink px-5 py-2 text-sm font-semibold text-white"
            >
              Continue shopping
            </Link>
          </div>
